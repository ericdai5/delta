...
\begin{figure*}[h]
\centering
\includegraphics[width=\textwidth]{fig/difficulty.pdf}
\caption{\textbf{Self-reported difficulty ratings.} Authors rated the difficulty of library features on a 5-point Likert scale ($n = 10$; some Task~2 features $n = 9$ due to ``did not do'' responses). The distribution largely mirrors the intuitiveness ratings (Figure~\ref{fig:obs-intuitiveness}), with most features rated as easy or very easy.}
