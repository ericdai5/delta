...
\begin{teaserfigure}
  ...
  \vspace{-1ex}
  \caption{\textbf{Delta lets authors turn static formulas into interactive explanations where readers can manipulate variables, walkthrough computation, and explore linked visualizations.} \normalfont The examples above demonstrate the range of interactions one can implement with Delta, from basic variable scrubbing (1) to systems of formulas (2), graphical equations (3), and linked interactive visuals (4). See Section~\ref{Gallery} for detailed descriptions of each example.}
  \vspace{2ex}
...
\input{06-evaluation-control}
\input{06-evaluation-observational}
\input{07-discussion}
\input{08-conclusion}
